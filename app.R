      ...
      tabsetPanel( type="tabs", selected="Map",
        ...
        tabPanel( title="Regions", br(), style="width: 350pt",
          p( HTML("For the purposes of fisheries management, Pacific Herring",
            "stocks in British Columbia are managed as five major and two", 
            "minor Stock Assessment Areas (SARs).",
        ...
        tabPanel( title="About", br(), style="width: 350pt",
          ...
          p( HTML("In this analysis, the default option is to summarise the",
            "spawn index by year and Location.",
            "Alternatively, users can choose to summarise spawns by Location",
            "(i.e., aggregate over years).",
