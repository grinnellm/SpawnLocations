      ...
      tabsetPanel( type="tabs", selected="Figure",
        ...
        tabPanel( title="Information", br(), style="width:350pt",
          ...
          p( "'Incomplete' spawns are included in this analysis; they are",
            ...
            "Note that data from the spawn survey is generally 'presence only'",
            "in that we record the presence of herring spawn, but we do not",
            "record the absense of herrring spawn.",
            "Thus, areas with no reported herring spawn could either have no",
            "spawn, or they may not have been surveyed." ),
