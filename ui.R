          ...
          bootstrapPage(
            div(
              ...
              p(HTML(
                ...
                "assumptions, as opposed to observed data,</li>",
                "<li>There are two different survey periods with substantial",
                "differences in survey effort (surface period from",
                paste0(qPeriods$Start[1], " to ", qPeriods$End[1], ","),
                "and dive period from",
